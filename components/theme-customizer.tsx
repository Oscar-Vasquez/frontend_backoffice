          ...
          <div className="grid gap-4 space-y-4 py-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Select
                ...
                <SelectTrigger className="col-span-3">
                  <SelectValue placeholder="Seleccionar color primario" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="flex flex-col gap-4">
              <Label htmlFor="roundedCorner">Bordes Redondeados</Label>
              <Slider
                id="roundedCorner"
                min={0}
                max={1.5}
            ...
            <RadioGroup
              ...
              <div>
                ...
                <Label
                  ...
                  <span className="block w-full p-2 text-center font-normal">Oscuro</span>
                </Label>
              </div>
            </RadioGroup>
            ...
            <div className="flex flex-col gap-4">
              <Label>Diseño del Contenido</Label>
              <RadioGroup
                value={contentLayout}
